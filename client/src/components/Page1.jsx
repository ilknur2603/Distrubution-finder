  ...
  return (
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            We allow the general public to donate to the organization of their choosing
              </h2>
        </div>
        ...
        <div class="px-5 py-8 mt-12 bg-white lg:mt-20 lg:p-16">
            <div class="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
                <div class="flex items-start">
                    <svg class="flex-shrink-0 w-16 h-16 text-cyan-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
