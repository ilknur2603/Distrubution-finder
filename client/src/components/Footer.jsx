  ...
  return (
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="flex flex-wrap items-center justify-between">
            <img class="h-8 auto md:order-1" src={logowhite} alt="" />
            ...
            <p class="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2023, All Rights Reserved by Group 3</p>
        </div>
    </div>
</section>
